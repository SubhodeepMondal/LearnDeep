...
//       and calculates the grid size based on the dimensions of the matrices.
// Note: The function uses double precision floating point numbers (double).
void gpu_mat_add_broadcast_f64(double *const *const ptr, const unsigned nDimA,
...
void gpu_mat_hadamard_mul_f64(double **ptr, const unsigned *dimA,
                              unsigned nDimA);
...
// - arr: An array of unsigned integers where arr[0] is the number of rows and
// arr[1] is the number of columns of the matrices.
void gpu_mat_hadamard_mul_broadcast_f64(
...
void gpu_reduce_sum_f64(double *const *const ptr, unsigned const *const arr);

void gpu_mat_relu_f64(double **ptr, const unsigned nDim, unsigned const *arr);

void gpu_mat_sigmoid_f64(double **ptr, unsigned *arr);

void gpu_mat_softmax_f64(double *const *const ptr, unsigned *const arr);
